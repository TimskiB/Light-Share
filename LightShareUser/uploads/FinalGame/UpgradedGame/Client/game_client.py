...
class GameClient:
    def __init__(self, identifier: str, match_id: str):
        ...
        identifier: str: Our user id from the app (chat server id)
        match_id:str: The id of the match so we know what info to receive
        """
    ...
    def receive_info(self):
        """
        Receive real-time server updates
        :return:
        """
        """
        :return: 
    ...
    def send_player(self, player: Player):
        """
        Send our movement to the server for updating for new users and to online users
    ...
    def send_bullet(self, bullet: Bullet):
        """
        Create a bullet object for all other users
        :param bullet:
        :return:
        """
        bullet_info = {
    ...
    def send_health(self, player: Enemy):
        """
        Notify that health has been changed
        :param player:
        :return:
        """
        health_info = {
