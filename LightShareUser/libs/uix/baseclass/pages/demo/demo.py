...
anita = {
    "name": "Anita",
    "image": "./libs/uix/baseclass/pages/assets/images/12.png",
    "active": True,
    "msg": chats["anita"],
    }
...
jooyce = {
    "name": "Jooyce",
    "image": "./libs/uix/baseclass/pages/assets/images/16.jpg",
    "active": False,
    "msg": chats["jooyce"],
    }
...
weeknd = {
    "name": "Weeknd",
    "image": "./libs/uix/baseclass/pages/assets/images/weeknd.jpg",
    "active": True,
    "msg": chats["weeknd"],
    }
...
jordan = {
    "name": "Jordan",
    "image": "./libs/uix/baseclass/pages/assets/images/jordan.jpg",
    "active": False,
    "msg": chats["jordan"],
    }
...
breezy = {
    "name": "Breezy",
    "image": "./libs/uix/baseclass/pages/assets/images/breezy.jpg",
    "active": True,
    "msg": chats["breezy"],
    }
...
wizkid = {
    "name": "Wizkid",
    "image": "./libs/uix/baseclass/pages/assets/images/wizkid.jpg",
    "active": False,
    "msg": chats["wizkid"],
    }
...
davido = {
    "name": "Davido",
    "image": "./libs/uix/baseclass/pages/assets/images/davido.jpg",
    "active": False,
    "msg": chats["davido"],
    }
...
zendaya = {
    "name": "Zendaya",
    "image": "./libs/uix/baseclass/pages/assets/images/14.jpg",
    "active": False,
    "msg": chats["zendaya"],
    }
...
rihanna = {
    "name": "Rihanna",
    "image": "./libs/uix/baseclass/pages/assets/images/rihanna.png",
    "active": True,
    "msg": chats["rihanna"],
    }
